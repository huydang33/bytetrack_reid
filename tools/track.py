...
from yolox.models.feature_extract_model import build_feature_extract_model
...
def make_parser():
    ...
    # reid model args
    parser.add_argument('--feat_model_name', type=str, default='resnet18', help='Feature extractor model name')
...
def main(exp, args, num_gpu):
    ...
    # Create model for feature extractor from bounding boxes
    feat_ext_model = build_feature_extract_model(args)
    ...
    evaluator = MOTEvaluator(
        ...
        feature_extract_model=feat_ext_model
        )
