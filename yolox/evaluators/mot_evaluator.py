...
class MOTEvaluator:
    ...
    def __init__(
        self, args, dataloader, img_size, confthre, nmsthre, num_classes, feature_extract_model):
        """
        Args:
    ...
    def evaluate(
        ...
        for cur_iter, (imgs, _, info_imgs, ids) in enumerate(
            ...
            if outputs[0] is not None:
                online_targets = tracker.update(outputs[0], info_imgs, self.img_size, imgs, self.feature_extract_model)
                online_tlwhs = []
                online_ids = []
                online_scores = []
